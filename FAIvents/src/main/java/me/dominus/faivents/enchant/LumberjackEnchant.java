...
public final class LumberjackEnchant extends Enchantment {

    private static final String LORE = "\u00a77\u041b\u0435\u0441\u043e\u0440\u0443\u0431";
    private static LumberjackEnchant instance;
    private static NamespacedKey key;

    private LumberjackEnchant(NamespacedKey key) {
        super(key);
    }

    public static LumberjackEnchant get() {
        return instance;
    }
    ...
    public static void register(JavaPlugin plugin) {
        ...
        key = new NamespacedKey(plugin, "lumberjack");
        Enchantment existing = Enchantment.getByKey(key);
        if (existing instanceof LumberjackEnchant) {
            instance = (LumberjackEnchant) existing;
            return;
        }
        LumberjackEnchant enchant = new LumberjackEnchant(key);
        try {
