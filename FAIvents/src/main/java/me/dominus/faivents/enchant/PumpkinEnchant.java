...
public final class PumpkinEnchant extends Enchantment {

    private static final String LORE = "\u00a77\u0422\u044b\u043a\u0432\u0430";
    private static PumpkinEnchant instance;
    private static NamespacedKey key;

    private PumpkinEnchant(NamespacedKey key) {
        super(key);
    }

    public static PumpkinEnchant get() {
        return instance;
    }
    ...
    public static void register(JavaPlugin plugin) {
        ...
        key = new NamespacedKey(plugin, "pumpkin");
        Enchantment existing = Enchantment.getByKey(key);
        if (existing instanceof PumpkinEnchant) {
            instance = (PumpkinEnchant) existing;
            return;
        }
        PumpkinEnchant enchant = new PumpkinEnchant(key);
        try {
