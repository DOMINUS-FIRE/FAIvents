...
public final class AssassinEnchant extends Enchantment {

    private static final String LORE = "\u00a77\u0410\u0441\u0441\u0430\u0441\u0438\u043d";
    private static AssassinEnchant instance;
    private static NamespacedKey key;

    private AssassinEnchant(NamespacedKey key) {
        super(key);
    }

    public static AssassinEnchant get() {
        return instance;
    }
    ...
    public static void register(JavaPlugin plugin) {
        ...
        key = new NamespacedKey(plugin, "assassin");
        Enchantment existing = Enchantment.getByKey(key);
        if (existing instanceof AssassinEnchant) {
            instance = (AssassinEnchant) existing;
            return;
        }
        AssassinEnchant enchant = new AssassinEnchant(key);
        try {
